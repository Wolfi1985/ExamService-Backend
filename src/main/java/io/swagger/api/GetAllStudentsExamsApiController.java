...
@Controller
public class GetAllStudentsExamsApiController implements GetAllStudentsExamsApi {

    private static final Logger log = LoggerFactory.getLogger(GetAllStudentsExamsApiController.class);
