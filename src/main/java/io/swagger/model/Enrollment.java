...
public class Enrollment   {
  ...
  @Valid
  private List<Students> participants = null;
  ...
  **/
  ...
  public Enrollment participants(List<Students> participants) {
    this.participants = participants;
    return this;
  }

  public Enrollment addParticipantsItem(Students participantsItem) {
    if (this.participants == null) {
      this.participants = new ArrayList<Students>();
    }
  ...
  **/
  ...
  public List<Students> getParticipants() {
    return participants;
  }

  public void setParticipants(List<Students> participants) {
    this.participants = participants;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.examId, enrollment.examId) &&
        Objects.equals(this.title, enrollment.title) &&
        Objects.equals(this.type, enrollment.type) &&
        Objects.equals(this.shortType, enrollment.shortType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(examId, title, type, shortType, semester, maxParticipants, enrollments, enrollmentStart, enrollmentEnd, examDate, examStart, examEnd, participants);
  }
